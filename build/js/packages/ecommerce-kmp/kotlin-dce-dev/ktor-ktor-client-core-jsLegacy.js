(function(root, factory) {
  ...
  var invoke_1 = defineInlineFunction('ktor-ktor-client-core-jsLegacy.io.ktor.client.fetch.invoke_jvo5iz$', function($receiver, evt) {
  $receiver(evt);
});
  var get_6 = defineInlineFunction('ktor-ktor-client-core-jsLegacy.io.ktor.client.fetch.get_1nqz5t$', function($receiver, index) {
  return $receiver[index];
});
  var set = defineInlineFunction('ktor-ktor-client-core-jsLegacy.io.ktor.client.fetch.set_uwgz9l$', function($receiver, index, value) {
  $receiver[index] = value;
});
  var get_7 = defineInlineFunction('ktor-ktor-client-core-jsLegacy.io.ktor.client.fetch.get_vmghym$', function($receiver, n) {
  return $receiver[n];
});
  var set_0 = defineInlineFunction('ktor-ktor-client-core-jsLegacy.io.ktor.client.fetch.set_y4mcs4$', function($receiver, n, value) {
  $receiver[n] = value;
});
  ...
  package$request.putAll_44jgzq$ = putAll;
