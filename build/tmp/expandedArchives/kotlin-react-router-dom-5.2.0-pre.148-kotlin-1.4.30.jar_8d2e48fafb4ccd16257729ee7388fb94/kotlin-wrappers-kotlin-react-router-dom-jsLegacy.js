(function (root, factory) {
  if (typeof define === 'function' && define.amd)
    define(['exports', 'kotlin', 'kotlin-wrappers-kotlin-react-jsLegacy', 'react-router-dom', 'kotlin-wrappers-kotlin-extensions-jsLegacy'], factory);
  else if (typeof exports === 'object')
    factory(module.exports, require('kotlin'), require('kotlin-wrappers-kotlin-react-jsLegacy'), require('react-router-dom'), require('kotlin-wrappers-kotlin-extensions-jsLegacy'));
  else {
    if (typeof kotlin === 'undefined') {
      throw new Error("Error loading module 'kotlin-wrappers-kotlin-react-router-dom-jsLegacy'. Its dependency 'kotlin' was not found. Please, check whether 'kotlin' is loaded prior to 'kotlin-wrappers-kotlin-react-router-dom-jsLegacy'.");
    }if (typeof this['kotlin-wrappers-kotlin-react-jsLegacy'] === 'undefined') {
      throw new Error("Error loading module 'kotlin-wrappers-kotlin-react-router-dom-jsLegacy'. Its dependency 'kotlin-wrappers-kotlin-react-jsLegacy' was not found. Please, check whether 'kotlin-wrappers-kotlin-react-jsLegacy' is loaded prior to 'kotlin-wrappers-kotlin-react-router-dom-jsLegacy'.");
    }if (typeof this['react-router-dom'] === 'undefined') {
      throw new Error("Error loading module 'kotlin-wrappers-kotlin-react-router-dom-jsLegacy'. Its dependency 'react-router-dom' was not found. Please, check whether 'react-router-dom' is loaded prior to 'kotlin-wrappers-kotlin-react-router-dom-jsLegacy'.");
    }if (typeof this['kotlin-wrappers-kotlin-extensions-jsLegacy'] === 'undefined') {
      throw new Error("Error loading module 'kotlin-wrappers-kotlin-react-router-dom-jsLegacy'. Its dependency 'kotlin-wrappers-kotlin-extensions-jsLegacy' was not found. Please, check whether 'kotlin-wrappers-kotlin-extensions-jsLegacy' is loaded prior to 'kotlin-wrappers-kotlin-react-router-dom-jsLegacy'.");
    }root['kotlin-wrappers-kotlin-react-router-dom-jsLegacy'] = factory(typeof this['kotlin-wrappers-kotlin-react-router-dom-jsLegacy'] === 'undefined' ? {} : this['kotlin-wrappers-kotlin-react-router-dom-jsLegacy'], kotlin, this['kotlin-wrappers-kotlin-react-jsLegacy'], this['react-router-dom'], this['kotlin-wrappers-kotlin-extensions-jsLegacy']);
  }
}(this, function (_, Kotlin, $module$kotlin_wrappers_kotlin_react_jsLegacy, $module$react_router_dom, $module$kotlin_wrappers_kotlin_extensions_jsLegacy) {
  'use strict';
