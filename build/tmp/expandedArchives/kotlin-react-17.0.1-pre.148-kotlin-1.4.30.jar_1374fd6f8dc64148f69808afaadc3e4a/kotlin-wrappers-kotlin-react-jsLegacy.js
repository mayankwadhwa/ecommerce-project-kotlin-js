(function (root, factory) {
  ...
  var useState = defineInlineFunction('kotlin-wrappers-kotlin-react-jsLegacy.react.useState_mh5how$', wrapFunction(function () {
    var rawUseState = _.$$importsForInline$$.react.useState;
    var Any = Object;
    var throwCCE = Kotlin.throwCCE;
    var RStateDelegate_init = _.react.RStateDelegate;
    return function (initValue) {
      var tmp$, tmp$_0;
      var tmp$_1 = rawUseState(initValue);
      var state = tmp$_1[0];
      var setState = tmp$_1[1];
      return new RStateDelegate_init((tmp$ = state) == null || Kotlin.isType(tmp$, Any) ? tmp$ : throwCCE(), typeof (tmp$_0 = setState) === 'function' ? tmp$_0 : throwCCE());
    };
  }));
  var useState_0 = defineInlineFunction('kotlin-wrappers-kotlin-react-jsLegacy.react.useState_klfg04$', wrapFunction(function () {
    var rawUseState = _.$$importsForInline$$.react.useState;
    var Any = Object;
    var throwCCE = Kotlin.throwCCE;
    var RStateDelegate_init = _.react.RStateDelegate;
    return function (valueInitializer) {
      var tmp$, tmp$_0;
      var tmp$_1 = rawUseState(valueInitializer);
      var state = tmp$_1[0];
      var setState = tmp$_1[1];
      return new RStateDelegate_init((tmp$ = state) == null || Kotlin.isType(tmp$, Any) ? tmp$ : throwCCE(), typeof (tmp$_0 = setState) === 'function' ? tmp$_0 : throwCCE());
    };
  ...
  var useCallback = defineInlineFunction('kotlin-wrappers-kotlin-react-jsLegacy.react.useCallback_3tr83r$', wrapFunction(function () {
    var useCallback = _.$$importsForInline$$.react.useCallback;
    return function (dependencies, callback) {
      return useCallback(callback, dependencies);
    };
  }));
  var useMemo = defineInlineFunction('kotlin-wrappers-kotlin-react-jsLegacy.react.useMemo_58jryq$', wrapFunction(function () {
