(function(root, factory) {
  if (typeof define === 'function' && define.amd) 
    define(['exports', 'kotlin', 'ktor-ktor-http-jsLegacy', 'ktor-ktor-io-jsLegacy', 'kotlinx-serialization-kotlinx-serialization-core-jsLegacy', 'ktor-ktor-client-json-jsLegacy'], factory);
  else if (typeof exports === 'object') 
    factory(module.exports, require('kotlin'), require('ktor-ktor-http-jsLegacy'), require('ktor-ktor-io-jsLegacy'), require('kotlinx-serialization-kotlinx-serialization-core-jsLegacy'), require('ktor-ktor-client-json-jsLegacy'));
  else {
  ...
  var JsonElement = $module$kotlinx_serialization_kotlinx_serialization_core_jsLegacy.kotlinx.serialization.json.JsonElement;
  ...
  Kotlin.defineModule('ktor-ktor-client-serialization-jsLegacy', _);
  return _;
}));
